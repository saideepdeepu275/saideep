            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="thumbnail">
                         <a class="thumbnail pull-left" href="#"> <img src="/carsfrontend/myImage/imageDisplay?id=${cart.productId}" style="height:50px;height: 50px" > </a> 
                    ...
                    <tr>
                        ...
                        <td>   </td>
                        <td><h5> </h5></td>
                        <td class="text-right"><h5><strong>${b}</strong></h5></td>
                    </tr>
                    <tr>
                        <td>   </td>
                        <td>   </td>
